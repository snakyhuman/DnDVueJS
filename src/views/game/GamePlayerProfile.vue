  ...
  <v-container>
    <v-card>
      <v-btn
        ...
        @click="isEdit = !isEdit"
      >{{ isEdit ? 'Изменить' : 'Сохранить' }}</v-btn>
      <v-row>
        <v-col xs="12" sm="12" md="6">
          <v-list-item>
            <v-list-item-avatar tile size="150" color="grey"></v-list-item-avatar>
            <v-list-item-content>
              <v-text-field dense label="Имя персонажа" :disabled="isEdit" v-model="player.name"></v-text-field>
              <v-select :items="['Муж.', 'Жен.' ]" :disabled="isEdit" dense label="Пол персонажа"></v-select>
              <v-select
                ...
                label="Раса"
              ></v-select>
              <v-list-item-title class="text-uppercase subtitle-2">уровень: {{player.level}}</v-list-item-title>
              <v-progress-linear value="20" height="25" dark rounded>
                <v-list-item-title
                  class="text-uppercase subtitle-2 text--white ml-1"
                >опыт: {{player.exp}}/ {{player.level*1000}}</v-list-item-title>
              </v-progress-linear>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-row class="mx-2">
            <v-col>
              <v-progress-linear color="green darken-4" value="20" height="25" dark rounded>
                <v-list-item-title
                  class="text-uppercase subtitle-2 text--white ml-1"
                >ОЗ: {{player.exp}}/ {{player.level*1000}}</v-list-item-title>
              </v-progress-linear>
            </v-col>
            <v-col>
              <v-progress-linear color="blue darken-4" value="20" height="25" dark rounded>
                <v-list-item-title
                  class="text-uppercase subtitle-2 text--white ml-1"
                >ОМ: {{player.exp}}/ {{player.level*1000}}</v-list-item-title>
              </v-progress-linear>
            </v-col>
            <v-col>
              <v-progress-linear color="brown darken-4" value="20" height="25" dark rounded>
                <v-list-item-title
                  class="text-uppercase subtitle-2 text--white ml-1"
                >ОД: {{player.exp}}/ {{player.level*1000}}</v-list-item-title>
              </v-progress-linear>
            </v-col>
          </v-row>
          ...
          <v-dialog v-model="invent" width="1000"></v-dialog>
        </v-col>
        <v-col xs="12" sm="12" md="6">
