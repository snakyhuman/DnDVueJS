    ...
    return {
      ...
      perks: [
        ...
        },
        {
            ...
            "description": "Чтобы стрелять - держи пушку крепко и жми на курок. Удачи, солдат!",
            "cost": "60",
            "ispositive": "1"
        },
        {
            "name": "ТРОЙНОЙ ВЫСТРЕЛ",
            "description": "Позволяет провести два выстрела подряд с точностью =15. Если хотя \r\nбы два патрона попадают в цель – критический выстрел и мгновенная \r\nсмерть.",
            "cost": "70",
            "ispositive": "1"
        },
        {
            "name": "БРОСОК ЛАССО",
            "description": "Вы можете обездвижить персонажа, накинув на него лассо (точность) до тех пор, пока его не освободят. Можно подтянуть обездвиженного к себе (ваша скорость+2 за действие)",
            "cost": "50",
            "ispositive": "1"
        },
        {
            "name": "БАНДИТ",
            "description": "Езда верхом, Зоркость +2, Точность -20, револьвер, Харизма -30.",
            "cost": "70",
            "ispositive": "1"
        },
        {
            "name": "ЖАРЕНЫМ ЗАПАХЛО",
            "description": "Вы всегда чувствуете, если окружающие настроены к вам негативно.",
            "cost": "70",
            "ispositive": "1"
        },
        {
        ...
        {
            "name": "ПОВАР",
            "description": "Можете готовить полноценную еду из всего подряд и даже в чистом поле",
            "cost": "40",
            "ispositive": "1"
        },
        {
            "name": "МОРЯК",
            "description": "Вы отлично умеете вязать узлы, ваше эмоциональное равновесие получает +25, точность +10, проворность +1",
            "cost": "70",
            "ispositive": "1"
        },
        {
        ...
        {
            "name": "КОВБОЙ",
            "description": "Бросок лассо, езда верхом, револьвер, +2 инициативы, +1 проворность, +10 силы",
            "cost": "100",
            "ispositive": "1"
        },
        {
            "name": "ТЕХАСЕЦ",
            "description": "20 к точности, перезарядка не является действием, 2 револьвера, стрельба с 2 рук.",
            "cost": "140",
            "ispositive": "1"
        },
        {
        ...
        {
            "name": "УКРОТИТЕЛЬ",
            "description": "Можете приманить животных и приручить, за каждое (разное) прирученное животное +1 к проворности",
            "cost": "100",
            "ispositive": "1"
        },
        {
        ...
        },
        {
            ...
            "description": "Вы не можете питаться чем попало (только полноценные блюда)",
            "cost": "40",
            "ispositive": "1"
        },
        {
        ...
        {
            "name": "ОТ БЕДРА",
            "description": "Нет возможности вести прицельную стрельбу ( точность всегда 40)",
            "cost": "-80",
            "ispositive": "0"
        },
        {
            "name": "НИК ВУЙЧИЧ",
            "description": "У вас отсутствуют верхние конечности ниже локтя\r\n(всё как бы валится из рук)",
            "cost": "-300",
            "ispositive": "0"
        },
        {
